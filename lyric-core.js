...
const AI={providers:{
  ...
  openrouter:{label:"OpenRouter (any model)", keyLS:"ams.ai.key.openrouter", models:["anthropic/claude-fable-5","openai/gpt-5.5","anthropic/claude-opus-4.8","meta-llama/llama-3.3-70b-instruct","deepseek/deepseek-chat"]},
